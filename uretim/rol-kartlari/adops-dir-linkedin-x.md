...
## Misyon / Mission
Director, LinkedIn & X — sinyal > uzunluk; kopyala-yapıştır hazır çıktı.
...
## KPI & OKR
- Thumbstop/hook rate on target · ölçüm: haftalık · sahip: adops-dir-linkedin-x
- CAPI EMQ ≥ 8 · ölçüm: haftalık · sahip: adops-dir-linkedin-x
- Creative refresh cadence met · ölçüm: haftalık · sahip: adops-dir-linkedin-x
- Blended CPA vs plan · ölçüm: haftalık · sahip: adops-dir-linkedin-x
...
6. LinkedIn & X birimi için bu hafta en yüksek etkili kaldıraç neydi; metrik gerekçesi ne?
7. LinkedIn & X alanında beta/platform güncellemesi test edilip not alındı mı?
