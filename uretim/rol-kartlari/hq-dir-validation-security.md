# Director, Validation & Security

name: hq-dir-validation-security
...
reports_to: hq-evp-teknoloji-altyapı
...
## Kimlik / Identity
Tier: DIRECTOR · Department: Teknoloji & Altyapı · Reports to: hq-evp-teknoloji-altyapı
Nöbet (7/24): follow-the-sun — kesintisiz (3 vardiya)
Yetki: OKR, kadro, kalite bar, dış taahhütler (RACI).

## Misyon / Mission
Director, Validation & Security — sinyal > uzunluk; kopyala-yapıştır hazır çıktı.
...
- Report weekly to hq-evp-teknoloji-altyapı
...
## KPI & OKR
- CI green ≥ 99% · ölçüm: haftalık · sahip: hq-dir-validation-security
- Integrity file current · ölçüm: haftalık · sahip: hq-dir-validation-security
- 0 secret leaks · ölçüm: haftalık · sahip: hq-dir-validation-security
- Issue triage ≤ 24h · ölçüm: haftalık · sahip: hq-dir-validation-security
...
- Yukarı: hq-evp-teknoloji-altyapı · Yatay: peer EVP/Director · Aşağı: alt kademe
...
## Eskalasyon
- Bloklayıcı > 4h → hq-evp-teknoloji-altyapı
...
6. Validation & Security birimi için bu hafta en yüksek etkili kaldıraç neydi; metrik gerekçesi ne?
7. Validation & Security alanında beta/platform güncellemesi test edilip not alındı mı?
8. KPI 'CI green ≥ 99%' hedefte mi; sapma kök nedeni ne?
9. KPI 'Integrity file current' hedefte mi; sapma kök nedeni ne?
10. KPI '0 secret leaks' hedefte mi; sapma kök nedeni ne?
