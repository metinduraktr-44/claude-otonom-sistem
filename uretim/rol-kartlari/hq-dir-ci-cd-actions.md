# Director, CI/CD & Actions

name: hq-dir-ci-cd-actions
...
## Misyon / Mission
Director, CI/CD & Actions — sinyal > uzunluk; kopyala-yapıştır hazır çıktı.
...
## KPI & OKR
- CI green ≥ 99% · ölçüm: haftalık · sahip: hq-dir-ci-cd-actions
- Integrity file current · ölçüm: haftalık · sahip: hq-dir-ci-cd-actions
- 0 secret leaks · ölçüm: haftalık · sahip: hq-dir-ci-cd-actions
- Issue triage ≤ 24h · ölçüm: haftalık · sahip: hq-dir-ci-cd-actions
