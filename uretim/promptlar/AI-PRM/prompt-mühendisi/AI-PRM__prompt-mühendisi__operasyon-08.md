...
- id: `AI-PRM::prompt-mühendisi::operasyon-08`
...
Bu prompt'un işi: Operasyon & ritm — senaryo 08 bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Operasyon & ritm — senaryo 08 için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `operasyon` senaryo 8: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__operasyon-08.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `operasyon` senaryo 8: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__operasyon-08.md` güncellenir.
