...
- id: `AI-PRM::prompt-mühendisi::iletisim-08`
...
Bu prompt'un işi: İletişim & rapor — senaryo 08 bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: İletişim & rapor — senaryo 08 için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `iletisim` senaryo 8: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__iletisim-08.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `iletisim` senaryo 8: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__iletisim-08.md` güncellenir.
