...
- id: `AI-PRM::prompt-mühendisi::gelir-14`
...
Bu prompt'un işi: Gelir & değer — senaryo 14 bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Gelir & değer — senaryo 14 için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `gelir` senaryo 14: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
