...
- id: `AI-PRM::prompt-mühendisi::uretim-14`
...
Bu prompt'un işi: Üretim & teslim — senaryo 14 bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Üretim & teslim — senaryo 14 için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `uretim` senaryo 14: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__uretim-14.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `uretim` senaryo 14: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__uretim-14.md` güncellenir.

## EK-3 Derinlik maddesi
- Prompt Mühendisi için `uretim` senaryo 14: alt kontrol 3 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__uretim-14.md` güncellenir.
