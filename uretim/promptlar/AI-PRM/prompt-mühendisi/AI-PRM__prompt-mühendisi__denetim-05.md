...
- id: `AI-PRM::prompt-mühendisi::denetim-05`
...
Bu prompt'un işi: Denetim & güvenlik — senaryo 05 bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Denetim & güvenlik — senaryo 05 için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `denetim` senaryo 5: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__denetim-05.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `denetim` senaryo 5: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__denetim-05.md` güncellenir.
