...
- id: `AI-PRM::prompt-mühendisi::strateji-02`
...
Bu prompt'un işi: Strateji & öncelik — senaryo 02 bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Strateji & öncelik — senaryo 02 için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `strateji` senaryo 2: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__strateji-02.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `strateji` senaryo 2: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__strateji-02.md` güncellenir.
