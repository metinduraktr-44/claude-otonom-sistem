...
- id: `AI-PRM::prompt-mühendisi::ozel-02`
...
Bu prompt'un işi: Kriz / kırmızı bayrak protokolü bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Kriz / kırmızı bayrak protokolü için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `ozel` senaryo 2: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__ozel-02.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `ozel` senaryo 2: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__ozel-02.md` güncellenir.

## EK-3 Derinlik maddesi
- Prompt Mühendisi için `ozel` senaryo 2: alt kontrol 3 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__ozel-02.md` güncellenir.
