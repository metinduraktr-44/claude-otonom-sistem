...
- id: `AI-PRM::prompt-mühendisi::operasyon-13`
...
Bu prompt'un işi: Operasyon & ritm — senaryo 13 bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Operasyon & ritm — senaryo 13 için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `operasyon` senaryo 13: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__operasyon-13.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `operasyon` senaryo 13: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__operasyon-13.md` güncellenir.
