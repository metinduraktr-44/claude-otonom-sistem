...
- id: `AI-PRM::prompt-mühendisi::strateji-03`
...
Bu prompt'un işi: Strateji & öncelik — senaryo 03 bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Strateji & öncelik — senaryo 03 için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `strateji` senaryo 3: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__strateji-03.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `strateji` senaryo 3: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__strateji-03.md` güncellenir.
