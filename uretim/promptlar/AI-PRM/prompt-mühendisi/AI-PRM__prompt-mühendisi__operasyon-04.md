...
- id: `AI-PRM::prompt-mühendisi::operasyon-04`
...
Bu prompt'un işi: Operasyon & ritm — senaryo 04 bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Operasyon & ritm — senaryo 04 için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `operasyon` senaryo 4: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__operasyon-04.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `operasyon` senaryo 4: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__operasyon-04.md` güncellenir.
