...
- id: `AI-PRM::prompt-mühendisi::gelir-05`
...
Bu prompt'un işi: Gelir & değer — senaryo 05 bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Gelir & değer — senaryo 05 için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `gelir` senaryo 5: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__gelir-05.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `gelir` senaryo 5: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__gelir-05.md` güncellenir.

## EK-3 Derinlik maddesi
- Prompt Mühendisi için `gelir` senaryo 5: alt kontrol 3 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__gelir-05.md` güncellenir.
