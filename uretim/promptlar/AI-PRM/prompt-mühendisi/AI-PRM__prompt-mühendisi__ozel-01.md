...
- id: `AI-PRM::prompt-mühendisi::ozel-01`
...
Bu prompt'un işi: Rol onboarding (ilk 48 saat) bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Rol onboarding (ilk 48 saat) için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `ozel` senaryo 1: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__ozel-01.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `ozel` senaryo 1: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__ozel-01.md` güncellenir.

## EK-3 Derinlik maddesi
- Prompt Mühendisi için `ozel` senaryo 1: alt kontrol 3 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__ozel-01.md` güncellenir.
