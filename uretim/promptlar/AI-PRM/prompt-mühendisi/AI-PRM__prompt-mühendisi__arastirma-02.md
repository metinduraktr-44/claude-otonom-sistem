...
- id: `AI-PRM::prompt-mühendisi::arastirma-02`
...
Bu prompt'un işi: Araştırma & damıtım — senaryo 02 bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Araştırma & damıtım — senaryo 02 için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `arastirma` senaryo 2: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__arastirma-02.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `arastirma` senaryo 2: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__arastirma-02.md` güncellenir.
