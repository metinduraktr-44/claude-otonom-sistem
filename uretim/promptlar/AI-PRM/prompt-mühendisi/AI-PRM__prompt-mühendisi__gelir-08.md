...
- id: `AI-PRM::prompt-mühendisi::gelir-08`
...
Bu prompt'un işi: Gelir & değer — senaryo 08 bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Gelir & değer — senaryo 08 için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `gelir` senaryo 8: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__gelir-08.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `gelir` senaryo 8: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__gelir-08.md` güncellenir.

## EK-3 Derinlik maddesi
- Prompt Mühendisi için `gelir` senaryo 8: alt kontrol 3 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__gelir-08.md` güncellenir.
