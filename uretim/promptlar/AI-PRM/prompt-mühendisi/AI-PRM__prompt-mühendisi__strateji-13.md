...
- id: `AI-PRM::prompt-mühendisi::strateji-13`
...
Bu prompt'un işi: Strateji & öncelik — senaryo 13 bağlamında Prompt Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Strateji & öncelik — senaryo 13 için Prompt Mühendisi teslimi
...
- Prompt Mühendisi için `strateji` senaryo 13: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__strateji-13.md` güncellenir.

## EK-2 Derinlik maddesi
- Prompt Mühendisi için `strateji` senaryo 13: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/prompt-mühendisi/AI-PRM__prompt-mühendisi__strateji-13.md` güncellenir.
