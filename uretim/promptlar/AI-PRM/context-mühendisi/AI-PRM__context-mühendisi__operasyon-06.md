...
- id: `AI-PRM::context-mühendisi::operasyon-06`
...
Bu prompt'un işi: Operasyon & ritm — senaryo 06 bağlamında Context Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Operasyon & ritm — senaryo 06 için Context Mühendisi teslimi
...
- Context Mühendisi için `operasyon` senaryo 6: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__operasyon-06.md` güncellenir.

## EK-2 Derinlik maddesi
- Context Mühendisi için `operasyon` senaryo 6: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__operasyon-06.md` güncellenir.
