...
- id: `AI-PRM::context-mühendisi::ozel-02`
...
Bu prompt'un işi: Kriz / kırmızı bayrak protokolü bağlamında Context Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Kriz / kırmızı bayrak protokolü için Context Mühendisi teslimi
...
- Context Mühendisi için `ozel` senaryo 2: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__ozel-02.md` güncellenir.

## EK-2 Derinlik maddesi
- Context Mühendisi için `ozel` senaryo 2: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__ozel-02.md` güncellenir.

## EK-3 Derinlik maddesi
- Context Mühendisi için `ozel` senaryo 2: alt kontrol 3 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__ozel-02.md` güncellenir.
