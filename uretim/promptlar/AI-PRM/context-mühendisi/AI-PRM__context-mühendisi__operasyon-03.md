...
- id: `AI-PRM::context-mühendisi::operasyon-03`
...
Bu prompt'un işi: Operasyon & ritm — senaryo 03 bağlamında Context Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Operasyon & ritm — senaryo 03 için Context Mühendisi teslimi
...
- Context Mühendisi için `operasyon` senaryo 3: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__operasyon-03.md` güncellenir.

## EK-2 Derinlik maddesi
- Context Mühendisi için `operasyon` senaryo 3: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__operasyon-03.md` güncellenir.
