...
- id: `AI-PRM::context-mühendisi::iletisim-01`
...
Bu prompt'un işi: İletişim & rapor — senaryo 01 bağlamında Context Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: İletişim & rapor — senaryo 01 için Context Mühendisi teslimi
...
- Context Mühendisi için `iletisim` senaryo 1: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__iletisim-01.md` güncellenir.

## EK-2 Derinlik maddesi
- Context Mühendisi için `iletisim` senaryo 1: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__iletisim-01.md` güncellenir.
