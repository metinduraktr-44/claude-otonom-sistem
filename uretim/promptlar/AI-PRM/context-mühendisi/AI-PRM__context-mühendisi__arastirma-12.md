...
- id: `AI-PRM::context-mühendisi::arastirma-12`
...
Bu prompt'un işi: Araştırma & damıtım — senaryo 12 bağlamında Context Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Araştırma & damıtım — senaryo 12 için Context Mühendisi teslimi
...
- Context Mühendisi için `arastirma` senaryo 12: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__arastirma-12.md` güncellenir.

## EK-2 Derinlik maddesi
- Context Mühendisi için `arastirma` senaryo 12: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__arastirma-12.md` güncellenir.
