...
- id: `AI-PRM::context-mühendisi::gelir-14`
...
Bu prompt'un işi: Gelir & değer — senaryo 14 bağlamında Context Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Gelir & değer — senaryo 14 için Context Mühendisi teslimi
...
- Context Mühendisi için `gelir` senaryo 14: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__gelir-14.md` güncellenir.

## EK-2 Derinlik maddesi
- Context Mühendisi için `gelir` senaryo 14: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__gelir-14.md` güncellenir.

## EK-3 Derinlik maddesi
- Context Mühendisi için `gelir` senaryo 14: alt kontrol 3 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__gelir-14.md` güncellenir.
