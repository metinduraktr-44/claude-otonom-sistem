...
- id: `AI-PRM::context-mühendisi::uretim-05`
...
Bu prompt'un işi: Üretim & teslim — senaryo 05 bağlamında Context Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Üretim & teslim — senaryo 05 için Context Mühendisi teslimi
...
- Context Mühendisi için `uretim` senaryo 5: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__uretim-05.md` güncellenir.

## EK-2 Derinlik maddesi
- Context Mühendisi için `uretim` senaryo 5: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/context-mühendisi/AI-PRM__context-mühendisi__uretim-05.md` güncellenir.
