...
- id: `INF-MCP::mcp-entegrasyon-mühendisi::ozel-02`
...
Bu prompt'un işi: Kriz / kırmızı bayrak protokolü bağlamında MCP Entegrasyon Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Kriz / kırmızı bayrak protokolü için MCP Entegrasyon Mühendisi teslimi
...
- MCP Entegrasyon Mühendisi için `ozel` senaryo 2: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__ozel-02.md` güncellenir.

## EK-2 Derinlik maddesi
- MCP Entegrasyon Mühendisi için `ozel` senaryo 2: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__ozel-02.md` güncellenir.
