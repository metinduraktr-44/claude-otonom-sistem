...
- id: `INF-MCP::mcp-entegrasyon-mühendisi::gelir-08`
...
Bu prompt'un işi: Gelir & değer — senaryo 08 bağlamında MCP Entegrasyon Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Gelir & değer — senaryo 08 için MCP Entegrasyon Mühendisi teslimi
...
- MCP Entegrasyon Mühendisi için `gelir` senaryo 8: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__gelir-08.md` güncellenir.

## EK-2 Derinlik maddesi
- MCP Entegrasyon Mühendisi için `gelir` senaryo 8: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__gelir-08.md` güncellenir.
