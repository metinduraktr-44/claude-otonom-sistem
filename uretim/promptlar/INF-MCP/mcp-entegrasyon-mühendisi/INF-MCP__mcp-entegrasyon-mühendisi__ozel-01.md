...
- id: `INF-MCP::mcp-entegrasyon-mühendisi::ozel-01`
...
Bu prompt'un işi: Rol onboarding (ilk 48 saat) bağlamında MCP Entegrasyon Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Rol onboarding (ilk 48 saat) için MCP Entegrasyon Mühendisi teslimi
...
- MCP Entegrasyon Mühendisi için `ozel` senaryo 1: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__ozel-01.md` güncellenir.

## EK-2 Derinlik maddesi
- MCP Entegrasyon Mühendisi için `ozel` senaryo 1: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__ozel-01.md` güncellenir.
