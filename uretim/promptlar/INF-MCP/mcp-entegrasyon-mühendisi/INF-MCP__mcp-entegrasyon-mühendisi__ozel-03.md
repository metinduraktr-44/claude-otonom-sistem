...
- id: `INF-MCP::mcp-entegrasyon-mühendisi::ozel-03`
...
Bu prompt'un işi: Handoff & bilgi aktarımı bağlamında MCP Entegrasyon Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Handoff & bilgi aktarımı için MCP Entegrasyon Mühendisi teslimi
...
- MCP Entegrasyon Mühendisi için `ozel` senaryo 3: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__ozel-03.md` güncellenir.

## EK-2 Derinlik maddesi
- MCP Entegrasyon Mühendisi için `ozel` senaryo 3: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__ozel-03.md` güncellenir.
