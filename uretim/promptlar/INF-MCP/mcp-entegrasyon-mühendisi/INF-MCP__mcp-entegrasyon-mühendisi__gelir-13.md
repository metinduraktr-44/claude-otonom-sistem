...
- id: `INF-MCP::mcp-entegrasyon-mühendisi::gelir-13`
...
Bu prompt'un işi: Gelir & değer — senaryo 13 bağlamında MCP Entegrasyon Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Gelir & değer — senaryo 13 için MCP Entegrasyon Mühendisi teslimi
...
- MCP Entegrasyon Mühendisi için `gelir` senaryo 13: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__gelir-13.md` güncellenir.

## EK-2 Derinlik maddesi
- MCP Entegrasyon Mühendisi için `gelir` senaryo 13: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__gelir-13.md` güncellenir.
