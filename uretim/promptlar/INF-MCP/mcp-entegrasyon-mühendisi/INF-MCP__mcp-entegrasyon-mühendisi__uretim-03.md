...
- id: `INF-MCP::mcp-entegrasyon-mühendisi::uretim-03`
...
Bu prompt'un işi: Üretim & teslim — senaryo 03 bağlamında MCP Entegrasyon Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Üretim & teslim — senaryo 03 için MCP Entegrasyon Mühendisi teslimi
...
- MCP Entegrasyon Mühendisi için `uretim` senaryo 3: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__uretim-03.md` güncellenir.

## EK-2 Derinlik maddesi
- MCP Entegrasyon Mühendisi için `uretim` senaryo 3: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__uretim-03.md` güncellenir.
