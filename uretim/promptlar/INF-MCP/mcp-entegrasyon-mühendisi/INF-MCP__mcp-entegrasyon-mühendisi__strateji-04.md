...
- id: `INF-MCP::mcp-entegrasyon-mühendisi::strateji-04`
...
Bu prompt'un işi: Strateji & öncelik — senaryo 04 bağlamında MCP Entegrasyon Mühendisi karar/üretim kalitesini maksimize etmek.
...
## 12. Örnek girdi
```
gorev: Strateji & öncelik — senaryo 04 için MCP Entegrasyon Mühendisi teslimi
...
- MCP Entegrasyon Mühendisi için `strateji` senaryo 4: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__strateji-04.md` güncellenir.

## EK-2 Derinlik maddesi
- MCP Entegrasyon Mühendisi için `strateji` senaryo 4: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/mcp-entegrasyon-mühendisi/INF-MCP__mcp-entegrasyon-mühendisi__strateji-04.md` güncellenir.
