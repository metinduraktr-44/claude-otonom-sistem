# PROMPT SÖZLEŞMESİ — Denetim & güvenlik — senaryo 04

- id: `INF-MCP::bağlayıcı-connector-uzmanı::denetim-04`
...
## 8. Senaryo-özel derinleştirme (Denetim & güvenlik — senaryo 04)
Bu prompt'un işi: Denetim & güvenlik — senaryo 04 bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (denetim-04)
...
## 12. Örnek girdi
```
gorev: Denetim & güvenlik — senaryo 04 için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `denetim` senaryo 4: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__denetim-04.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `denetim` senaryo 4: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__denetim-04.md` güncellenir.
