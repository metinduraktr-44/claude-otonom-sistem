# PROMPT SÖZLEŞMESİ — Kriz / kırmızı bayrak protokolü

- id: `INF-MCP::bağlayıcı-connector-uzmanı::ozel-02`
...
## 8. Senaryo-özel derinleştirme (Kriz / kırmızı bayrak protokolü)
Bu prompt'un işi: Kriz / kırmızı bayrak protokolü bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (ozel-02)
...
## 12. Örnek girdi
```
gorev: Kriz / kırmızı bayrak protokolü için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `ozel` senaryo 2: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__ozel-02.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `ozel` senaryo 2: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__ozel-02.md` güncellenir.
