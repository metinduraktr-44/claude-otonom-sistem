# PROMPT SÖZLEŞMESİ — Strateji & öncelik — senaryo 08

- id: `INF-MCP::bağlayıcı-connector-uzmanı::strateji-08`
...
## 8. Senaryo-özel derinleştirme (Strateji & öncelik — senaryo 08)
Bu prompt'un işi: Strateji & öncelik — senaryo 08 bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (strateji-08)
...
## 12. Örnek girdi
```
gorev: Strateji & öncelik — senaryo 08 için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `strateji` senaryo 8: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__strateji-08.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `strateji` senaryo 8: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__strateji-08.md` güncellenir.
