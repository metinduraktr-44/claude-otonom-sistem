# PROMPT SÖZLEŞMESİ — İletişim & rapor — senaryo 06

- id: `INF-MCP::bağlayıcı-connector-uzmanı::iletisim-06`
...
## 8. Senaryo-özel derinleştirme (İletişim & rapor — senaryo 06)
Bu prompt'un işi: İletişim & rapor — senaryo 06 bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (iletisim-06)
...
## 12. Örnek girdi
```
gorev: İletişim & rapor — senaryo 06 için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `iletisim` senaryo 6: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__iletisim-06.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `iletisim` senaryo 6: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__iletisim-06.md` güncellenir.
