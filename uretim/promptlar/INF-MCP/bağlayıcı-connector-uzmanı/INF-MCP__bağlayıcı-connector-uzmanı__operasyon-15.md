# PROMPT SÖZLEŞMESİ — Operasyon & ritm — senaryo 15

- id: `INF-MCP::bağlayıcı-connector-uzmanı::operasyon-15`
...
## 8. Senaryo-özel derinleştirme (Operasyon & ritm — senaryo 15)
Bu prompt'un işi: Operasyon & ritm — senaryo 15 bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (operasyon-15)
...
## 12. Örnek girdi
```
gorev: Operasyon & ritm — senaryo 15 için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `operasyon` senaryo 15: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__operasyon-15.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `operasyon` senaryo 15: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__operasyon-15.md` güncellenir.
