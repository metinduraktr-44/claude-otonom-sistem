# PROMPT SÖZLEŞMESİ — Operasyon & ritm — senaryo 05

- id: `INF-MCP::bağlayıcı-connector-uzmanı::operasyon-05`
...
## 8. Senaryo-özel derinleştirme (Operasyon & ritm — senaryo 05)
Bu prompt'un işi: Operasyon & ritm — senaryo 05 bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (operasyon-05)
...
## 12. Örnek girdi
```
gorev: Operasyon & ritm — senaryo 05 için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `operasyon` senaryo 5: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__operasyon-05.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `operasyon` senaryo 5: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__operasyon-05.md` güncellenir.
