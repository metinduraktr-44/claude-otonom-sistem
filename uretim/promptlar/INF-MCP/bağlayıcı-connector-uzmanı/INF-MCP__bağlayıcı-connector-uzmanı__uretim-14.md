# PROMPT SÖZLEŞMESİ — Üretim & teslim — senaryo 14

- id: `INF-MCP::bağlayıcı-connector-uzmanı::uretim-14`
...
## 8. Senaryo-özel derinleştirme (Üretim & teslim — senaryo 14)
Bu prompt'un işi: Üretim & teslim — senaryo 14 bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (uretim-14)
...
## 12. Örnek girdi
```
gorev: Üretim & teslim — senaryo 14 için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `uretim` senaryo 14: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__uretim-14.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `uretim` senaryo 14: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__uretim-14.md` güncellenir.
