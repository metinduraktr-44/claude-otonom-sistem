# PROMPT SÖZLEŞMESİ — Üretim & teslim — senaryo 05

- id: `INF-MCP::bağlayıcı-connector-uzmanı::uretim-05`
...
## 8. Senaryo-özel derinleştirme (Üretim & teslim — senaryo 05)
Bu prompt'un işi: Üretim & teslim — senaryo 05 bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (uretim-05)
...
## 12. Örnek girdi
```
gorev: Üretim & teslim — senaryo 05 için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `uretim` senaryo 5: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__uretim-05.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `uretim` senaryo 5: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__uretim-05.md` güncellenir.
