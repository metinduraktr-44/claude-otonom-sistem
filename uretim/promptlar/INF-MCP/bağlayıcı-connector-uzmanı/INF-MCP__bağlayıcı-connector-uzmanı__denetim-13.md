# PROMPT SÖZLEŞMESİ — Denetim & güvenlik — senaryo 13

- id: `INF-MCP::bağlayıcı-connector-uzmanı::denetim-13`
...
## 8. Senaryo-özel derinleştirme (Denetim & güvenlik — senaryo 13)
Bu prompt'un işi: Denetim & güvenlik — senaryo 13 bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (denetim-13)
...
## 12. Örnek girdi
```
gorev: Denetim & güvenlik — senaryo 13 için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `denetim` senaryo 13: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__denetim-13.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `denetim` senaryo 13: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__denetim-13.md` güncellenir.
