# PROMPT SÖZLEŞMESİ — Handoff & bilgi aktarımı

- id: `INF-MCP::bağlayıcı-connector-uzmanı::ozel-03`
...
## 8. Senaryo-özel derinleştirme (Handoff & bilgi aktarımı)
Bu prompt'un işi: Handoff & bilgi aktarımı bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (ozel-03)
...
## 12. Örnek girdi
```
gorev: Handoff & bilgi aktarımı için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `ozel` senaryo 3: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__ozel-03.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `ozel` senaryo 3: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__ozel-03.md` güncellenir.
