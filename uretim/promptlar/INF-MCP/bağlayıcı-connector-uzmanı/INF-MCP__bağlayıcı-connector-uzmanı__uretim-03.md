# PROMPT SÖZLEŞMESİ — Üretim & teslim — senaryo 03

- id: `INF-MCP::bağlayıcı-connector-uzmanı::uretim-03`
...
## 8. Senaryo-özel derinleştirme (Üretim & teslim — senaryo 03)
Bu prompt'un işi: Üretim & teslim — senaryo 03 bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (uretim-03)
...
## 12. Örnek girdi
```
gorev: Üretim & teslim — senaryo 03 için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `uretim` senaryo 3: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__uretim-03.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `uretim` senaryo 3: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__uretim-03.md` güncellenir.
