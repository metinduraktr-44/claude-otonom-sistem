# PROMPT SÖZLEŞMESİ — Strateji & öncelik — senaryo 15

- id: `INF-MCP::bağlayıcı-connector-uzmanı::strateji-15`
- rol: **Bağlayıcı (Connector) Uzmanı**
- departman: `INF-MCP` · başkan: `CIO`
- aile: Strateji & öncelik
...
## 8. Senaryo-özel derinleştirme (Strateji & öncelik — senaryo 15)
Bu prompt'un işi: Strateji & öncelik — senaryo 15 bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (strateji-15)
...
## 12. Örnek girdi
```
gorev: Strateji & öncelik — senaryo 15 için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `strateji` senaryo 15: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__strateji-15.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `strateji` senaryo 15: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__strateji-15.md` güncellenir.
