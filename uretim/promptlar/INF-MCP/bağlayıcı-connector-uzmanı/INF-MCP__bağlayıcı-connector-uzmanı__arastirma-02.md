# PROMPT SÖZLEŞMESİ — Araştırma & damıtım — senaryo 02

- id: `INF-MCP::bağlayıcı-connector-uzmanı::arastirma-02`
...
## 8. Senaryo-özel derinleştirme (Araştırma & damıtım — senaryo 02)
Bu prompt'un işi: Araştırma & damıtım — senaryo 02 bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (arastirma-02)
...
## 12. Örnek girdi
```
gorev: Araştırma & damıtım — senaryo 02 için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `arastirma` senaryo 2: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__arastirma-02.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `arastirma` senaryo 2: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__arastirma-02.md` güncellenir.
