# PROMPT SÖZLEŞMESİ — Rol onboarding (ilk 48 saat)

- id: `INF-MCP::bağlayıcı-connector-uzmanı::ozel-01`
...
## 8. Senaryo-özel derinleştirme (Rol onboarding (ilk 48 saat))
Bu prompt'un işi: Rol onboarding (ilk 48 saat) bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (ozel-01)
...
## 12. Örnek girdi
```
gorev: Rol onboarding (ilk 48 saat) için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `ozel` senaryo 1: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__ozel-01.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `ozel` senaryo 1: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__ozel-01.md` güncellenir.
