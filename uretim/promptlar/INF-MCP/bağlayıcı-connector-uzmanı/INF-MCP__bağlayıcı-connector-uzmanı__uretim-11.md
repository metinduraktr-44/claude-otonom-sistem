# PROMPT SÖZLEŞMESİ — Üretim & teslim — senaryo 11

- id: `INF-MCP::bağlayıcı-connector-uzmanı::uretim-11`
...
## 8. Senaryo-özel derinleştirme (Üretim & teslim — senaryo 11)
Bu prompt'un işi: Üretim & teslim — senaryo 11 bağlamında Bağlayıcı (Connector) Uzmanı karar/üretim kalitesini maksimize etmek.
...
## 11. Operasyon kontrol listesi (uretim-11)
...
## 12. Örnek girdi
```
gorev: Üretim & teslim — senaryo 11 için Bağlayıcı (Connector) Uzmanı teslimi
...
- Bağlayıcı (Connector) Uzmanı için `uretim` senaryo 11: alt kontrol 1 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__uretim-11.md` güncellenir.

## EK-2 Derinlik maddesi
- Bağlayıcı (Connector) Uzmanı için `uretim` senaryo 11: alt kontrol 2 — kanıt türü, karar eşiği, dokümantasyon yolu, audit alanı.
- Çıktı alanı: `uretim/promptlar/bağlayıcı-connector-uzmanı/INF-MCP__bağlayıcı-connector-uzmanı__uretim-11.md` güncellenir.
