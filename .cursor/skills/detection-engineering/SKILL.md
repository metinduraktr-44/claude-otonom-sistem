...
description: "Tespit kuralı taslağı (savunma). Defense-only Security OS skill. Use for ASSESS-ONLY gap/control work."
---
...
2. Girdi: `SECURITY_CONTEXT/` + ilgili motor klasörü (`IMPLEMENTATION/`)
