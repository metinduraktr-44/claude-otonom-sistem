...
description: Detection rules ↔ D3FEND/ATT&CK detect map. DEFENSE-ONLY: detection, hardening, compliance, IR playbooks. No exploits, phish…
---

# detection-engineering

Detection rules ↔ D3FEND/ATT&CK detect map.
...
Deep sample: `references/sigma-d3fend.md`
