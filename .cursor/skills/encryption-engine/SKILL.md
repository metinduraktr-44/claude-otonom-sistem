...
description: Crypto at rest/in transit; agility; no break-crypto. DEFENSE-ONLY: detection, hardening, compliance, IR playbooks. No exploits, phish…
---

# encryption-engine

Crypto at rest/in transit; agility; no break-crypto.
...
## Expansion (FAZ 3)
Deep sample: `references/crypto-hygiene.md`
