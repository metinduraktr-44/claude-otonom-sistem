...
description: Zero Trust architecture patterns. DEFENSE-ONLY: detection, hardening, compliance, IR playbooks. No exploits, phish…
---
...
## Expansion (FAZ 3)
Deep sample: `references/zt-principles.md`
