...
description: CSPM posture assessment (read/assess). DEFENSE-ONLY: detection, hardening, compliance, IR playbooks. No exploits, phish…
---

# cloud-security-posture

CSPM posture assessment (read/assess).
