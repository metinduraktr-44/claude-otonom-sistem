...
description: Transparent, auditable code & SBOM-friendly diffs. DEFENSE-ONLY: detection, hardening, compliance, IR playbooks. No exploits, phish…
---

# transparent-code-engine

Transparent, auditable code & SBOM-friendly diffs.
...
## Expansion (FAZ 3)
Deep sample: `references/decision-traceability.md`
