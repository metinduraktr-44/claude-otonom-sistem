...
description: "Değişiklik/onay protokolü kontrolleri. Defense-only Security OS skill. Use for ASSESS-ONLY gap/control work."
---
...
## Trigger
Değişiklik/onay protokolü kontrolleri
...
2. Girdi: `SECURITY_CONTEXT/` + ilgili motor klasörü (`CHANGE/`)
