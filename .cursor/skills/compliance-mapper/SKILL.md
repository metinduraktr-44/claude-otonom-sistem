...
description: Map controls to NIST/ISO/SOC2/D3FEND. DEFENSE-ONLY: detection, hardening, compliance, IR playbooks. No exploits, phish…
---

# compliance-mapper

Map controls to NIST/ISO/SOC2/D3FEND.
...
Deep sample: `references/nist-csf-control-fields.md`
