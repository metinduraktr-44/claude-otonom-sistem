---
name: security-expert-engine
description: Security EXPERTS seed cards; no fabricated rankings. DEFENSE-ONLY: detection, hardening, compliance, IR playbooks. No exploits, phish…
---

# security-expert-engine

Security EXPERTS seed cards; no fabricated rankings.
...
## Expansion (FAZ 3)
Deep sample: `references/expert-card-contract.md`
