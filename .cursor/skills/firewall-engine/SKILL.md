...
description: "Ağ/uygulama engel politikası iskeleti. Defense-only Security OS skill. Use for ASSESS-ONLY gap/control work."
---
...
## Trigger
Ağ/uygulama engel politikası iskeleti
...
2. Girdi: `SECURITY_CONTEXT/` + ilgili motor klasörü (`FIREWALLS/`)
