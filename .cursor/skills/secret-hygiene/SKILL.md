---
name: secret-hygiene
description: Secret detection hygiene; placeholders only. DEFENSE-ONLY: detection, hardening, compliance, IR playbooks. No exploits, phish…
---

# secret-hygiene

Secret detection hygiene; placeholders only.
...
Deep sample: `references/patterns.md`
