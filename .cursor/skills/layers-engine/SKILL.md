---
name: layers-engine
description: Defense-in-depth layer cards + NIST mapping. DEFENSE-ONLY: detection, hardening, compliance, IR playbooks. No exploits, phish…
---

# layers-engine

Defense-in-depth layer cards + NIST mapping.
...
Deep sample: `references/defense-in-depth.md`
