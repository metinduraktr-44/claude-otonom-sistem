---
name: security-qa
description: Security QA checklists for ASSESS-ONLY reviews. DEFENSE-ONLY: detection, hardening, compliance, IR playbooks. No exploits, phish…
---

# security-qa

Security QA checklists for ASSESS-ONLY reviews.
...
## Expansion (FAZ 3)
Deep sample: `references/qa-rubric.md`
