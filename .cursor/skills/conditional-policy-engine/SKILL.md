...
description: "Koşullu erişim/politika kontrolleri. Defense-only Security OS skill. Use for ASSESS-ONLY gap/control work."
---
...
## Trigger
Koşullu erişim/politika kontrolleri
...
2. Girdi: `SECURITY_CONTEXT/` + ilgili motor klasörü (`CONDITIONAL/`)
