---
name: conditional-policy-engine
description: Conditional access / policy-as-code (deny-by-default). DEFENSE-ONLY: detection, hardening, compliance, IR playbooks. No exploits, phish…
---

# conditional-policy-engine

Conditional access / policy-as-code (deny-by-default).
...
## Expansion (FAZ 3)
Deep sample: `references/policy-rules.md`
