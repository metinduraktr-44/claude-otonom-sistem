...
> Üretim: 2026-08-10T03:49:09Z · İlke: secret ASLA commit edilmez · free tier tercih · credential yoksa dry-run
...
| `OPENROUTER_API_KEY` | Holding LLM (alternatif) | https://openrouter.ai/keys | dry-run iskelet | opsiyonel |
